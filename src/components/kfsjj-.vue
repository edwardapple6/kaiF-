      ...
      <div class="btns02">
        <div class="btn02"
            ...
            <div class="btn02-wrap"
              ...
              <span class="btn-txt02">{{ btn.txt }}</span>
            </div>
        </div>
      </div>
    </div>
...
export default {
    ...
    return {
      ...
      btnSec: [
        ...
        },
        {
          src: src05,
          txt: '定投',
          url: 'jjdt.html' // http://192.168.0.101:8081/dist/pages/putong/qq/hysxq.js
        },
        {
          src: src06,
          txt: '分红',
  ...
  methods: {
    ...
    changePage (index, btnNum) {
      //清除缓存
      localStorage.removeItem('jjzh_zrjj')
      localStorage.removeItem('jjzh_zcjj')
      localStorage.removeItem('kh')
      localStorage.removeItem('jjkh')
      localStorage.removeItem('jjzh')
